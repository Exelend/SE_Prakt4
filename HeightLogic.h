...
private:
    ...
    unsigned short bandhoehe[5] = {3776, 3769, 3773};
    unsigned short hoehe1_3[5] = {3457, 3358, 3405, 3408, 50};
    unsigned short hoehe2[5] = {3727, 3689, 3710};
    unsigned short hoehe4[5] = {3112, 3033, 3068};
